   ...
   */
   protected boolean addValue(String subject, String variable, String value, boolean addToLines)
   {
      ...
      if (!subjects.contains(subject)) 
      {
         ...
         variables.addElement(new Vector<Object>());
         values.addElement(new Vector<Object>());
      }

      //set the value, if the variable doesn't exist, add it to the end of the subject
      int subjectIndex = subjects.indexOf(subject);
      Vector<String> subjectVariables = (Vector<String>)(variables.elementAt(subjectIndex));
      Vector<String> subjectValues = (Vector<String>)(values.elementAt(subjectIndex));
